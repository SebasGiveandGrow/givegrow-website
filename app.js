...
var I18N = {
  es: {
    ...
    "mmc.p.hero.ey":"Tras el sismo del 10 de agosto",
    "mmc.p.hero.alt":"Vivienda de dos plantas visitada por la brigada en Ansermanuevo, con el segundo piso en ladrillo a la vista",
    "mmc.p.b1.t":"Revisa tu casa",
    "mmc.p.b1.s":"Se afectó y quiero un concepto",
    "mmc.p.b2.t":"Soy ingeniero",
    "mmc.p.b2.s":"Quiero revisar casos",
    "mmc.p.b3.t":"Quiero apadrinar",
    "mmc.p.b3.s":"Puedo aportar a una reparación",
    "mmc.p.b.pie":"Las tres puertas del proyecto. Si no sabes cuál es la tuya, empieza por la primera.",
    "mmc.p.hero.pie":"Ansermanuevo, agosto de 2026. Una de las viviendas que visitó la brigada.",
    ...
    "cv.t":"Revisa tu casa",
    "cv.lead":"Si tu casa se afectó por el sismo, sube unas fotos. Un ingeniero voluntario te dice si hay señales para no permanecer en ella, qué precauciones tomar y con qué materiales conviene repararla.",
    "cv.aviso":"Esto no reemplaza una visita ni la declaratoria de tu municipio. Un ingeniero voluntario mira tus fotos y te escribe lo que alcance a ver desde ahí: qué precauciones tomar mientras tanto y, cuando puede decirlo con lo que enviaste, por dónde conviene empezar a reparar. Sobre fotos no se ve todo, así que hay cosas que ningún ingeniero va a firmar sin ir hasta la casa.",
    ...
    "cv.nombre":"Tu nombre",
    "cv.tel":"Tu WhatsApp",
    "cv.tel.h":"Lo usamos para contactarte si necesitamos más fotos o para coordinar una visita.",
    ...
    "cv.ej.si":"SIRVE",
    "cv.ej.no":"NO ALCANZA",
    "cv.ej.1":"El daño de cerca: se ve por dónde va la grieta y qué tan ancha es.",
    "cv.ej.2":"Y la casa entera, para saber en qué parte está el daño.",
    "cv.ej.3":"Tan cerca que solo se ve la ventana. No se sabe en qué muro está ni qué le pasó.",
    "cv.ej.4":"De muy abajo y en diagonal: el muro sale torcido y el daño, si lo hay, no se alcanza a ver.",
    "cv.ej.fin":"Si no puedes tomar alguna sin arriesgarte, no lo hagas: cuéntalo en las observaciones y ya.",
    ...
    "cv.ok.enlace":"Este es el enlace de tu caso. Guárdalo o mándatelo por WhatsApp: cuando un ingeniero lo revise, aquí aparecerá su concepto.",
    ...
    "ing.q1.p":"Das un concepto a distancia: si hay señales para no permanecer en la casa o en una parte de ella, qué precauciones tomar mientras tanto, y con qué materiales y en qué orden conviene repararla. Y ordenas la fila: visita urgente, programada, no requiere por ahora, o no se puede evaluar con este material.",
    "ing.q2.t":"Lo que no haces",
    "ing.q2.p":"No declaras habitable ni inhabitable una vivienda, y nadie te va a pedir que firmes eso aquí: la declaratoria con efectos —evacuar, demoler— es de la autoridad municipal, por la Ley 1523 de 2012. Recomendar que no se use una parte de la casa mientras se revisa no es declararla inhabitable: es una precaución, y así queda escrita.",
    ...
    "ing.p4.p":"Abres un caso, ves sus fotos y lo clasificas. No ves el nombre, ni el teléfono, ni la dirección de la familia: para dar el concepto no hacen falta, y quien las necesita para ir a visitar es el equipo de terreno.",
    "ing.f.t":"Lo que va con tu nombre",
    "ing.f.p":"La familia recibe un PDF con tu nombre, tu matrícula y lo que escribiste. Por eso puedes revisar los casos que quieras y ninguno que no quieras, y por eso siempre está abierta la salida de pedir más material. Nada de esto se cobra, en ninguna dirección.",
    ...
    "ing.esp.otra":"Otra",
    "ing.esp.cual":"¿Cuál?",
    "ing.posgrado":"Especialización, maestría o doctorado (opcional)",
    "ing.posgrado.ph":"Especialización en estructuras, Universidad Nacional",
    "ing.posgrado.h":"Si tienes varios, sepáralos con comas.",
    "ing.diplomados":"Diplomados o cursos (opcional)",
    "ing.diplomados.ph":"Evaluación de daños post-sismo, patología de estructuras…",
    "ing.diplomados.h":"Cuentan los cortos y los de gremio. Si es sobre evaluación post-sismo, dilo: eso pesa aquí.",
    "ing.otros":"Otros conocimientos, dentro o fuera de la ingeniería (opcional)",
    "ing.otros.ph":"Construcción en bahareque o tapia, trabajo con comunidad, lengua indígena, gestión del riesgo…",
    "ing.otros.h":"Nos sirve tanto como un título. Muchas de estas casas son de adobe o bahareque, y quien sabe leerlas no siempre lo aprendió en la universidad.",
    ...
    "ing.alcance":"Entiendo que doy un concepto a distancia —permanencia, precauciones, materiales y prioridad de visita— y que NO es un dictamen de habitabilidad: esa declaratoria es de la autoridad municipal. Recomendar que no se use una parte de la casa mientras se revisa es una precaución, no una declaratoria.",
    ...
    "donar.foto.alt":"Territorio wayuu en la Alta Guajira, con burros de carga bajo los árboles",
    "donar.conf.1":"NIT 901.948.930-2",
    ...
    "hero.cred.ey":"Entidad verificable",
    "hero.cred.t":"Fundación Give&Grow International",
    "hero.cred.nat.k":"Naturaleza",
    "hero.cred.nat.v":"ESAL · Régimen Tributario Especial",
    ...
    /* MARCO DE ACTUACIÓN (`std.*`). La página que traduce lo que ya hacemos al
       idioma en el que lo evalúa un aliado institucional. Los ODS ya estaban en
       «Cómo medimos» y están escritos para una empresa; esto es la otra mitad,
       la humanitaria, que es la que corresponde a un programa de alojamiento
       después de un sismo.

       EL CUADRO DE LA NORMA HUMANITARIA ESENCIAL NO ESTÁ TODO EN VERDE Y ESO ES
       EL PUNTO. Tres compromisos van a medias y uno no existe todavía. Un cuadro
       entero cumplido sería comprobable y falso en diez minutos; este resiste la
       comprobación, que es lo único que sirve. */
    "std.ey":"Marco de actuación",
    "std.t":"Bajo qué normas trabajamos, y qué no afirmamos.",
    "std.lead":"Give&Grow International es una entidad colombiana sin ánimo de lucro que hoy opera dos cosas: un hub de donaciones con trazabilidad documental, y un triaje estructural de viviendas tras el sismo del 10 de agosto de 2026. Esta página reúne lo que un aliado institucional necesita comprobar antes de trabajar con nosotros, incluidos los vacíos que todavía estamos cerrando.",
    "std.ident":"La identidad legal, la gobernanza y los documentos públicos",

    "std.chs.ey":"Norma Humanitaria Esencial",
    "std.chs.t":"Los nueve compromisos, uno por uno",
    "std.chs.p":"La Norma Humanitaria Esencial en materia de calidad y rendición de cuentas es el marco con el que se mide a una organización que responde a una emergencia. Lo que sigue es dónde estamos en cada compromiso, con lo que se puede comprobar y sin redondear hacia arriba.",
    "std.chs.h1":"Compromiso",
    "std.chs.h2":"Qué existe hoy",
    "std.chs.h3":"Estado",
    "std.est.op":"Operando",
    "std.est.par":"Parcial",
    "std.est.con":"En construcción",
    "std.chs.c1":"1 · Respuesta pertinente",
    "std.chs.c1.p":"El triaje ordena por gravedad y no por orden de llegada, y cada clasificación la firma un ingeniero con matrícula verificada. Qué se entrega en territorio lo define la fundación aliada que está allí, no nosotros desde Medellín.",
    "std.chs.c2":"2 · Respuesta oportuna",
    "std.chs.c2.p":"No prometemos fechas porque no las tenemos: los ingenieros son voluntarios y son menos que las casas. Lo que sí damos es el dato comprobable en la pantalla de cada familia — los días que lleva esperando y cuántos casos siguen sin abrir.",
    "std.chs.c3":"3 · No causar daño",
    "std.chs.c3.p":"No declaramos si una vivienda es habitable: esa competencia es de la autoridad municipal por la Ley 1523 de 2012, y extralimitarnos sería el daño. Los programas los ejecutan las fundaciones del territorio y el crédito es suyo, con su nombre.",
    ...
    "std.dnh.t":"Orientar, no dictaminar",
    "std.dnh.p":"Un ingeniero voluntario mira las fotografías de una vivienda afectada y escribe si hay señales para no permanecer en ella, qué precauciones tomar y con qué materiales conviene repararla. Lo que nunca escribe es si la casa es habitable.",
    "std.dnh.p2":"Esa declaratoria tiene efectos —evacuar, demoler— y en Colombia le corresponde a la autoridad de cada municipio por la Ley 1523 de 2012. Un privado que la emitiera a distancia estaría desplazando a quien sí responde por ella, y la familia quedaría con un papel que no la protege de nada. Por eso la distinción no es una advertencia al pie: gobierna el proyecto entero, hasta el nombre de las columnas de la base de datos, y es una casilla obligatoria que cada ingeniero acepta antes de ver su primer caso.",

    "std.dat.ey":"Datos personales",
    "std.dat.t":"Minimización, y no solo consentimiento",
    "std.dat.p":"El tratamiento se rige por la Ley 1581 de 2012 y su Decreto 1377 de 2013. Más allá del consentimiento, el sistema está construido para que cada quien vea lo mínimo:",
    "std.dat.1":"El ingeniero que evalúa una vivienda no ve el nombre, el teléfono ni la dirección de la familia. Para dar el concepto no hacen falta, y quien sí los necesita para ir a visitar es el equipo de terreno.",
    "std.dat.2":"El registro público de casas revisadas no lleva nombres, direcciones ni fotografías: solo el sector y la prioridad. Y solo aparece la familia que lo autorizó.",
    "std.dat.3":"Toda autorización se puede retirar, y retirarla obliga a despublicar. Las fotografías de menores tienen protección reforzada por la Ley 1098 de 2006.",
    ...
    "std.no.3.p":"Somos una fundación joven, constituida en 2025. No tenemos una década de programas ni un equipo grande, y preferimos decirlo antes que se note.",

    "std.ver.ey":"Cómo comprobarlo",
    "std.ver.t":"Nada de esto pide que nos creas",
    "std.ver.1":"El registro oficial, la gobernanza y los documentos públicos",
    "std.ver.2":"El registro público de viviendas revisadas",
    "std.ver.3":"Cómo medimos, y el mapeo a ODS, GRI y ESG",
    ...
    "faq.q11":"Mi casa se afectó por el sismo. ¿Qué hacen ustedes?",
    "faq.a11":"Si el peligro es AHORA —un muro a punto de caer, olor a gas, alguien atrapado— llama al 123 y a tu alcaldía: eso no espera. Para lo demás existe Mira Mi Casa: subes fotos de tu casa y un ingeniero voluntario con matrícula te da un concepto a distancia, sin costo. Te dice si hay señales para no permanecer en la casa o en alguna parte de ella, qué precauciones tomar mientras tanto, y con qué materiales y en qué orden conviene repararla.",
    "faq.q12":"¿Me van a decir si mi casa es habitable?",
    "faq.a12":"No, y conviene que sepas por qué. Por fotos no se ve la cimentación, ni el suelo, ni si esa grieta está en un muro que carga. Y la declaratoria con efectos —evacuar, demoler— es de la autoridad de tu municipio y no de un privado: lo fija la Ley 1523 de 2012. Lo que sí te damos es un concepto sobre lo que las fotos permiten ver. Y si te recomendamos no usar una parte de la casa mientras la revisan, eso es una precaución, no una declaratoria de inhabitabilidad.",
    "faq.q13":"¿Me van a reparar la casa o darme los materiales?",
    "faq.a13":"No podemos comprometerlo casa por casa, y preferimos decírtelo antes que prometerte algo que no depende solo de nosotros. Como fundación vamos a buscar gestionar ayuda para todas las casas que podamos. Lo que sí recibes con seguridad es el concepto: con qué materiales y en qué orden conviene reparar, para que sepas por dónde empezar incluso si los consigues por tu cuenta.",
    ...
    "brig.mmc3.d":"Aporta materiales, mano de obra, transporte o dinero para las casas que ya tienen concepto. No se cobra nada en línea y no se compromete una casa concreta: primero queda registrado el ofrecimiento y después se conversa.",
    ...
    "brig.dar.dinero.p":"Si prefieres el banco de siempre, esta es la cuenta: Fundación Give&Grow International, NIT 901.948.930-2. Cuando transfieras, repórtalo en el sitio y te damos tu número de guía al instante — así no queda dependiendo de que alguien vea un correo.",
    "brig.dar.linea.k":"En dinero · en línea",
    "brig.dar.linea.p":"Tarjeta o botón Bancolombia, en dos minutos. Vuelves con un número de guía y con eso puedes seguir tu aporte hasta la foto del acta que firma quien recibe.",
...
var ROUTE_META = {
  ...
  estandares:{t:{es:"Marco de actuación · Give&Grow International",en:"How we work · Give&Grow International"},d:{es:"Bajo qué normas trabaja Give&Grow: la Norma Humanitaria Esencial compromiso por compromiso, el límite legal de la Ley 1523, la protección de datos y lo que deliberadamente no afirmamos.",en:"The standards Give&Grow works to: the Core Humanitarian Standard commitment by commitment, the legal limit set by Colombia's Law 1523, data protection, and what we deliberately do not claim."}},
...
function ingSubmit(ev){
  ...
  fetch("/api/inscripcion", {
    ...
    body: JSON.stringify({
      ...
      posgrado: val("inf-posgrado"),
      diplomados: val("inf-diplomados"),
      otros_saberes: val("inf-otros"),
